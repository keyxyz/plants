...
% --- Metadata ---
\title[Herbal Plant Classification]{Comparative Evaluation of ORB-Based BoVW, CNN, and Transfer Learning for Herbal Plant Recognition}
\subtitle{Computer Vision Semester Project - Final Exam}
\author[Henry Ssenono]{Henry Ssenono 2025/HD05/26373/U \\ \small{Paper ID *****}}
...
\begin{frame}
    ...
    \vspace{2em}
    \footnotesize Computer Vision Semester Project
\end{frame}
